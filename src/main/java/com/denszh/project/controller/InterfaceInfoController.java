...
import com.denszh.project.model.dto.interfaceinfo.InterfaceInfoAddRequest;
import com.denszh.project.model.dto.interfaceinfo.InterfaceInfoQueryRequest;
import com.denszh.project.model.dto.interfaceinfo.InterfaceInfoUpdateRequest;
...
public class InterfaceInfoController {
    ...
    public BaseResponse<Long> addInterfaceInfo(@RequestBody InterfaceInfoAddRequest interfaceInfoAddRequest, HttpServletRequest request) {
        ...
        boolean result = interfaceInfoService.save(interfaceInfo);//Iservice的save
        if (!result) {
